...
public class FroggerGameImpl extends UnicastRemoteObject implements FroggerGameRI{
    ...
    public FroggerGameImpl( HashMap<UtilRI,GameStateRI> utils, int n, ProjectMainImpl pm) throws RemoteException {
        super();
        this.Utils = utils;
        this.N=n;
        this.PM = pm;
    ...
    public String Difficulty(int difficulty) throws RemoteException {
        switch (difficulty){
            case 1:
                ...
                return "Difficulty has been set at " + Dific;
            case 2:
            ...
            default:
                this.Dific= String.valueOf(Difficulty.MEDIUM);
                return "Invalid option Default has been selected " + Dific;
        }
    }
