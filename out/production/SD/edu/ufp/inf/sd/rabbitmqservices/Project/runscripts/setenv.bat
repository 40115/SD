  ...
  @Set WORKDRIVE=C
  @Set JDK=%WORKDRIVE%:\Program Files\Java\jdk1.8.0_202
  ...
  @set JAVAPROJ=%WORKDRIVE%:\\Users\\ruben\\IdeaProjects\\%JAVAPROJ_NAME%
  ...
  @Set EXCHANGE_NAME_PREFIX=Queuema
  @Set PRODUCER_CLASS_PREFIX=Cliente
  @Set BACKEND_CLASS_PREFIX=Backend
  @Set FRONTEND_CLASS_PREFIX=Frontend
