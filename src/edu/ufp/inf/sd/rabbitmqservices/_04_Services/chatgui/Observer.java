package edu.ufp.inf.sd.rabbitmqservices._04_Services.chatgui;
...
channelToRabbitMq.exchangeDeclare(this.exchangeName,this.exchangeType);
    ...
    private void attachConsumerToChannelExchangeWithKey() {
        try {
            ...
            String h= this.channelToRabbitMq.queueDeclare(this.exchangeName, false, true, true, null).getQueue();
            ...
            this.channelToRabbitMq.queueBind(h,this.exchangeName,exchangeBindingKeys[0]);
            this.channelToRabbitMq.queueBind(h,this.exchangeName,exchangeBindingKeys[1]);
            ...
            this.channelToRabbitMq.basicConsume(h,true,deliverCallback,cancelCalback);
    ...
    public void sendMessage(String msgToSend, String user) throws IOException {
        ...
        this.channelToRabbitMq.basicPublish(this.exchangeName,user,prop,msgToSend.getBytes());
