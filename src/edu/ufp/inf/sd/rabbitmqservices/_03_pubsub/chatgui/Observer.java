...
import edu.ufp.inf.sd.rabbitmqservices._03_pubsub.chatgui.ObserverGuiClient;
...
this.channelToRabbitMq.queueBind(h,this.exchangeName,"");
...
this.gui.updateTextArea();
            ...
            this.channelToRabbitMq.basicConsume(h,true,deliverCallback,cancelCallback);
    ...
    public void sendMessage(String msgToSend) throws IOException {
        ...
        this.channelToRabbitMq.basicPublish(this.exchangeName,routingKey,null,msgToSend.getBytes());
    }
